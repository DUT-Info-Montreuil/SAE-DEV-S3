                ...
                ?>
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card mb-4 shadow-sm">
                            <img src="<?=$quete["image"]?>" alt="Quest" class="card-img-top">
                            <div class="card-body">
                                <h5 class="card-title"><?=$quete["titre"]?></h5>
                                <p class="card-text"><?=$quete["descriptif"]?></p>
                            </div>
                        </div>
                    </div>
                <?php
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><?=$ennemi["titre"]?></h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card mb-4 shadow-sm">
                        <img src="<?=$tourelle["image"]?>" alt="Quest" class="card-img-top">
                        <div class="card-body">
                            <h5 class="card-title"><?=$tourelle["titre"]?></h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card mb-4 shadow-sm">
                        <img src="<?=$obstacle["image"]?>" alt="Quest" class="card-img-top">
                        <div class="card-body">
                            <h5 class="card-title"><?=$obstacle["titre"]?></h5>
